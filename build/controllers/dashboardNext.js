...
export const versionNextIncrement = async (req, res) => {
    try {
...
export const versionNextDecrement = async (req, res) => {
    try {
...
export const getNextLast = async (req, res) => {
    try {
        const data = await fs.promises.readFile(global.__dirname + `/public/configs/next/mainnet/last.json`);
...
export const getNextConfig = async (req, res) => {
    try {
        ...
        const data = await fs.promises.readFile(global.__dirname + `/public/configs/next/mainnet/v${v}.json`);
        const config = JSON.parse(data);
...
export const saveNextConfig = async (req, res) => {
    try {
        ...
        let data = await fs.promises.readFile(global.__dirname + `/public/configs/next/mainnet/assets/a${assets}.json`);
...
export const getNextLogs = async (req, res) => {
    try {
...
//# sourceMappingURL=dashboardNext.js.map